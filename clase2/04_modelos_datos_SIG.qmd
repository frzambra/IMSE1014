...
4. Atributos
5. Tipos de modelos de datos geoespaciales

# ¿Qué hemos visto? {background-color='orange'}

## ¿Qué hemos visto hasta ahora? {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
# 4. Atributos {background-color='red'}
...
# 5. Tipos de modelos de datos espaciales {background-color='orange'}
