---
title: "Taller 3: Sistemas de Referencias de Coordenadas"
...
- `Actividad 3`: Explorar el sistema de coordenadas Universal Transversal de Mercator (UTM)
- `Actividad 4`: Repaso: Exportar proyecciones, crear archivos geopackages, agregar mapa de referencia.
...
3. Mida la ditancia entre el centro del circulo que se encuentra en el extremo norte y el centro del circulo que se encuentra en el extremo sur. Aprecie la diferencia entre la medida en `Cartesiano` y `Elipsoidal`. ¿A qué se debe? Anoté la distancia de la proyección (cartesiano) y el SRC en una tabla. 

4. Calculé el área de Chile con las diferentes proyecciones que vamos a ir analizando.
...
## Actividad 5: Exportar capas en diferentes proyecciones, crear archivos geopackages, agregar mapa de referencia.

1. Exporte los mapas a diferentes proyecciones
2. Cree un archivo geopackage con varias capas
3. Agregue un mapa de referencia satelital a QGIS
