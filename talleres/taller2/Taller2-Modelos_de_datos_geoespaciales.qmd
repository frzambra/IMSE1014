...
-   `Actividad 5:` formatos de datos geoespaciales vectoriales y raster.
...
-   `datos vectoriales`: desde la IDE del Ministerio de Medio Ambiente (https://www.ide.cl/index.php/medio-ambiente) debe descargar las siguientes capas:
    -   `cuencas BNA`: delimitación de las cuencas hidrográficas de Chile.
    -   `estaciones de calidad de aire`: estaciones de monitoreo del Sistema de Información Nacional de Calidad de aire (SINCA) .
    -   `sendero de Chile`: Conjunto de rutas que atraviesan el país, contribuyendo a la protección de la naturaleza, a través de la generación de un espacio de acceso público. Esta información se encuentra para todo el país.
    - `data_vectorial_taller2.gpkg`: archivo en formato geopackage. Lo debe descargar desde el campus virtual.
    
-   `datos raster`:
    -   `imágen aérea:` descargue la siguiente imágen <https://t.ly/cScMI>
    -   `precipitación Chile`: <https://chelsa-chile.s3.amazonaws.com/monthly/pre/CHELSA_pr_v2.1_20190601.tif>
    -   `temperatura Chile`: <https://chelsa-chile.s3.amazonaws.com/monthly/tas/CHELSA_tas_v2.1_20190601.tif>
