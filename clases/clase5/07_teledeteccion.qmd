...
::: {.columns}
::: {.column width=50%}
![](img/cloroa_clorob_espectra.jpg){fig-align='center' width=100%}
:::
::: {.column width=50%}
...
## ¿En qué difieren? {.smaller background-image="../../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
Dos tipos de imágenes satelitales
