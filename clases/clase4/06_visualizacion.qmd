...
- ¿cómo comunicar de mejor forma la comunicación de ideas?
...
## 3. formato del mapa, limitaciones de impresión, costo de reproducción {.smaller .scrollable background-image="../../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
- contiene caractéristicas importantes al mensaje del mapa
