...
4. Conceptos del espacio

# 1. Utilidad de los SIG {background-color="darkgreen"}

## Algunas aplicaciones {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## ¿Cómo nos pueden servir los SIG para medio ambiente? {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## IDE Ministerio de Medio Ambiente  {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}

`IDE`: Infraestructura de datos espaciales  
`SINIA`: Sistema Nacional de Información Ambiental

[https://ide.mma.gob.cl/](https://ide.mma.gob.cl/)
...
## Definición de SIG {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Los SIG como un paraguas {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Las seis partes de los SIG {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## ¿Cómo pueden ser usados los SIG? {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}
...
## Revolución geo-espacial {.smaller .scrollable background-image="../logo_medioambiente.jpeg" background-position="97.5% 2.5%" background-size="7.5%" layout="true"}

Ejemplo de uso de la tecnología geoespacial 

[https://www.youtube.com/watch?v=poMGRbfgp38&feature=youtu.be](https://www.youtube.com/watch?v=poMGRbfgp38&feature=youtu.be)

# 4. Conceptos del espacio {background-color='orange'}
